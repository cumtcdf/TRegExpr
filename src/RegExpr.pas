...
{$ENDIF}
      ...
      // If true, then 邪-褟  additional include russian letter '褢',
      // 袗-携  additional include '衼', and 邪-携 include all russian symbols.
...
begin
  ...
  if val < scan then
    ...
    // "P 鈥?Q computes the difference between the address given
...
{$IFDEF UniCode}
  ...
  RusRangeLoLow = #$430 { '邪' };
  RusRangeLoHigh = #$44F { '褟' };
  RusRangeHiLow = #$410 { '袗' };
  RusRangeHiHigh = #$42F { '携' };
{$ELSE}
  RusRangeLo = '邪斜胁谐写械褢卸蟹懈泄泻谢屑薪芯锌褉褋褌褍褎褏褑褔褕褖褗褘褜褝褞褟';
  RusRangeHi = '袗袘袙袚袛袝衼袞袟袠袡袣袥袦袧袨袩袪小孝校肖啸笑效楔些歇蝎鞋协挟携';
  RusRangeLoLow = '邪';
  RusRangeLoHigh = '褟';
  RusRangeHiLow = '袗';
  RusRangeHiHigh = '携';
